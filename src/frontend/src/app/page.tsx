...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-base-100 p-6" data-oid="qztw-kl">
      <div
        className="flex flex-col items-center text-center gap-2 mt-8 mb-8"
        data-oid="j_rrgmg"
      >
        <div className="flex items-center gap-3" data-oid="cgo1d-7">
          <span role="img" aria-label="speech bubble" data-oid="33tke:e">
            💬
          </span>

          <h1 className="text-3xl font-bold" data-oid="9d_25ax">
            Whisper
          </h1>
        </div>
        <p className="text-base text-slate-600" data-oid="vgzmoo4">
          Fix your voice agents, faster
        </p>
      </div>

      <div className="max-w-5xl mx-auto space-y-4" data-oid="9cm8gl2">
        {/* Step 1: Input */}
        <div className="card bg-base-100 shadow-xl" data-oid="o4222g1">
          <div className="card-body p-5" data-oid="0vba:8i">
            <div className="flex items-center gap-3 mb-3" data-oid="5wgn8cy">
              <div
              ...
              <h2 className="text-xl font-bold" data-oid="_h-rmwx">
                Upload Inputs
              </h2>
            </div>

            <div className="space-y-3" data-oid="f.5g1wf">
              <div data-oid="fq83b52">
                <label
                  className="text-slate-600 font-semibold mb-1 pl-1 text-base inline-block"
                  data-oid="jf1h6l5"
                >
                  Voice Agent Prompt
                </label>
            ...
            <div className="flex justify-end mt-6" data-oid="zgo-rth">
              <button
        ...
        {/* Step 2: Analysis */}
        <div className="card bg-base-100 shadow-xl" data-oid="1jt:okv">
          <div className="card-body p-5" data-oid="82x_t7x">
            <div className="flex items-center gap-3 mb-3" data-oid="2sju:j3">
              <div
                className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center text-primary font-semibold text-sm"
                data-oid="5eih54r"
              >
              ...
              <h2 className="text-xl font-bold" data-oid="3h.p893">
                Analyzing & Fixing
              </h2>
            </div>

            <div
              className="bg-primary/10 rounded-xl p-5 flex flex-col items-center justify-center gap-3"
              data-oid=":78ep_4"
            >
              {!isProcessing && !messages.length ? (
                <p className="text-primary" data-oid="l1rna-8">
                  Click &apos;Run Task&apos; to start the process
                </p>
              ) : (
                <>
                  {isProcessing && (
                    <div className="flex items-center gap-4" data-oid="ktk5vqg">
                      <div
                        className="loading loading-spinner loading-md text-primary"
                        data-oid="obj1tgf"
                      ></div>
                      <p className="text-primary text-sm" data-oid="obfysjj">
                        Magic in progress...
                      </p>
                    </div>
                  )}
                  {messages.length > 0 && (
                    <div
                      className="w-full max-h-48 overflow-y-auto mt-4 space-y-2"
                      data-oid="bag3m80"
                    >
                      {messages.map((msg, index) => (
                        ...
                        >
                          ...
                          <span data-oid=".:gpb-p">{msg.message}</span>
                        </div>
                      ))}
                    </div>
                  )}
        ...
        {/* Step 3: Results */}
        <div className="card bg-base-100 shadow-xl" data-oid="0upri2:">
          <div className="card-body p-5" data-oid="q-4:lnh">
            <div className="flex items-center gap-3 mb-3" data-oid="jobk9j4">
              <div
                className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center text-primary font-semibold text-sm"
                data-oid="v4n7cb4"
              >
              ...
              <h2 className="text-xl font-bold" data-oid="5nwol31">
                Results
              </h2>
            </div>

            {hasResults ? (
              <div className="space-y-6" data-oid="986da6q">
                <div
                  className="bg-white rounded-lg overflow-hidden shadow-sm"
                  data-oid=".y4qx2q"
                >
                  <div
                    className="sticky top-0 z-10 bg-gray-50 border-b border-gray-200 p-3 flex justify-between items-center"
                    data-oid="a5-i4n_"
                  >
                    <div
                ...
                <div className="flex justify-end mt-4 mb-8" data-oid="msg61rg">
                  <button
                ...
                <div className="divider my-0" data-oid="vvmtpym"></div>

                {/* Line Changes Summary */}
                <div
                  className="bg-white rounded-lg overflow-hidden shadow-sm p-4 pt-2"
                  data-oid="we-jy1t"
                >
                  <h3 className="text-xl font-bold mb-4" data-oid="yutqpmc">
                    Summary of Changes
                  </h3>
                  <div className="space-y-4" data-oid="peuxyob">
                    {lineChanges.removed.length > 0 && (
                      <div className="mb-4" data-oid="qjj3t5n">
                        <h4
                        ...
                        {(() => {
                          ...
                          return groups.map((group, groupIndex) => {
                            ...
                            return (
                              ...
                              >
                                <div
                                  className="text-[15px] leading-relaxed text-gray-700 mb-2 flex items-center gap-1.5"
                                  data-oid="qscb4zm"
                                >
                                  <span
                                ...
                                <div
                                  className="bg-red-50 rounded-md p-4"
                                  data-oid="-lx1ll8"
                                >
                                  <div
                                  ...
                                  <div
                                    className="whitespace-pre-wrap font-mono text-[14px] leading-relaxed"
                                    data-oid="yd-_9of"
                                  >
                                    {group.lines
                    ...
                    {lineChanges.added.length > 0 && (
                      <div data-oid="c4z5-au">
                        <h4
                          className="text-[15px] text-gray-600 font-medium mb-4"
                          data-oid="k1ymqkw"
                        >
                          Added Lines
                        </h4>
              ...
              <div
                className="text-base-content/70 text-center py-4"
                data-oid="rj43z4l"
              >
